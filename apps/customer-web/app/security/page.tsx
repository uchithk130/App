      ...
      <KcalAppLayout>
        <div className="min-h-dvh bg-[#f7f8f7] pb-28 lg:pb-12">
          <main className="mx-auto max-w-2xl px-4 pt-8 lg:px-6">
            <Link href="/profile" className="mb-6 inline-flex items-center gap-1 text-sm font-medium text-emerald-600">
            ...
            <section className="mt-4 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
              ...
              {sessionsQ.isLoading ? (
                ...
                <div className="space-y-2">
                  {currentSession && (
                    <div className={"flex items-center gap-3 rounded-xl border-2 border-emerald-100 bg-emerald-50/30 p-3"}>
